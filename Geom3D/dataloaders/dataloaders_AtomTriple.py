...
class BatchAtomTriple(Data):
    def __init__(self, batch=None, **kwargs):
        super(BatchAtomTriple, self).__init__(**kwargs)
        self.batch = batch
...
class DataLoaderAtomTriple(DataLoader):
    def __init__(self, dataset, batch_size=1, shuffle=True, **kwargs):
        super(DataLoaderAtomTriple, self).__init__(
            dataset,
            batch_size,
            shuffle,
            collate_fn=lambda data_list: BatchAtomTriple.from_data_list(data_list),
            **kwargs)